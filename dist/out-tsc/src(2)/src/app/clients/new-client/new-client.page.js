...
var NewClientPage = /** @class */ (function () {
    function NewClientPage(messageService, toast, dbm, form_builder, router, camera, geolocation, alert) {
    ...
    NewClientPage = tslib_1.__decorate([
        ...
        tslib_1.__metadata("design:paramtypes", [MessageService, ToastController, Database_manager, FormBuilder, Router, Camera, Geolocation, AlertController])
    ], NewClientPage);
