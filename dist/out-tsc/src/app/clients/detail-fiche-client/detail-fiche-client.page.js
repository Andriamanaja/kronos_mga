...
var DetailFicheClientPage = /** @class */ (function () {
    function DetailFicheClientPage(photoViewer, camera, messageService, toast, load, data_router, geolocation, storage, dbm, form_builder, router, activatedRoute) {
    ...
    DetailFicheClientPage.prototype.open_full_screen = function () {
        this.photoViewer.show(this.data_cli.photo);
    };
    DetailFicheClientPage = tslib_1.__decorate([
        ...
        tslib_1.__metadata("design:paramtypes", [PhotoViewer, Camera, MessageService, ToastController, LoadingController, Data, Geolocation, Storage, Database_manager, FormBuilder, Router, ActivatedRoute])
