 ...
 * AFADeleteOptions
 */
export declare class AndroidFingerprintAuthOriginal extends IonicNativePlugin {
    /**
...
export declare const AndroidFingerprintAuth: AndroidFingerprintAuthOriginal;