(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ngx-formly/core'), require('@angular/forms'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/core/json-schema', ['exports', '@angular/core', '@ngx-formly/core', '@angular/forms', 'rxjs/operators'], factory) :
    (factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].core = global['ngx-formly'].core || {}, global['ngx-formly'].core['json-schema'] = {}),global.ng.core,global['ngx-formly'].core,global.ng.forms,global.rxjs.operators));
}(this, (function (exports,i0,core,forms,operators) { 'use strict';
                            ...
                            if (schemaDeps_1[key]) {
                                ...
                                if (oneOfSchema
                                     ...
                                     */function (oneOfSchema) {
                                        var _a = oneOfSchema.properties, _b = key, constSchema = _a[_b], properties = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
                                        field.fieldGroup.push(__assign({}, _this_1._toFieldConfig(__assign({}, oneOfSchema, { properties: properties }), options), { hideExpression: ( /**
                                                 * @param {?} m
                                                 * @return {?}
                    ...
                    fieldGroup: [
                        {
                            ...
                            hooks: {
                                 ...
                                 */function (v) { return v !== -1; }));
                                    ...
                                    f.formControl = new forms.FormControl(formattedValue);
                                    setTimeout(( /**
                                     * @return {?}
                                     */function () { return checkField(modeField); }));
                                    subscription = f.formControl.valueChanges.pipe(operators.startWith(formattedValue), operators.pairwise()).subscribe(( /**
                                     * @param {?} __0
                                     * @return {?}
                                     */function (_a) {
                        ...
                        },
                        {
                             ...
                             * @return {?}
                             */function (s, i) {
                                return (__assign({}, _this_1._toFieldConfig(s, options), { hideExpression: ( /**
                                         * @param {?} m
                                         * @param {?} fs
                                         * @param {?} f
                                         * @return {?}
