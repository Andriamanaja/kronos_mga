(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('@angular/common'), require('@angular/core'), require('rxjs'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/core', ['exports', 'rxjs/operators', '@angular/common', '@angular/core', 'rxjs', '@angular/forms'], factory) :
    (factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].core = {}),global.rxjs.operators,global.ng.common,global.ng.core,global.rxjs,global.ng.forms));
}(this, (function (exports,operators,common,i0,rxjs,forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormlyForm = /** @class */ (function () {
        ...
        immutable, parentFormGroup) {
            ...
            this.checkExpressionChange$ = this.modelChange.pipe(operators.debounceTime(this.enableCheckExprDebounce ? 100 : 0)).subscribe(( /**
             * @return {?}
             */function () {
                 ...
                 */function (field) {
                    if (field.key && !field.fieldGroup) {
                         ...
                         */function (value) {
                            ...
                            _this.changeModel({ key: __spread(rootKey, getKeyPath(field)).join('.'), value: value });
                        })));
                    }
     ...
     */ FieldFormExtension = /** @class */ (function () {
         ...
         */
            function (field) {
                ...
                /** @type {?} */
                var paths = getKeyPath(field);
                if (field.formControl instanceof forms.AbstractControl || (form && form.get(paths))) {
