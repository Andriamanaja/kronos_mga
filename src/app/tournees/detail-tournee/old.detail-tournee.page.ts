...
export class DetailTourneePage implements OnInit {
  ...
  constructor(private alert: AlertController, private fb: FormBuilder, private geolocation: Geolocation, private activated_route: ActivatedRoute, private storage: Storage, private dbm: Database_manager, private route: Router) {
  ...
  async go_fiche_visite() {
    ...
    await this.route.navigate(["fiche-visite"], navigation_extra);
  }
